        ...
        {messages.length > 0 && !isMessagesLoading ? (
          <div className="max-w-3xl mx-auto space-y-6">
            {messages.flatMap((msg, index) => {
              ...
              const prevDay =
                index > 0 ? getDayKey(messages[index - 1].createdAt) : null;
              ...
              if (showDateSeparator) {
                items.push(
                  ...
                  >
                    <span className="px-3 py-1 text-xs font-medium rounded-full bg-slate-700/90 text-slate-300 backdrop-blur-sm shadow-sm">
